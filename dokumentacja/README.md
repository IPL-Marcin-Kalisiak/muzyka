...
Strona `/violin` ma interaktywny syntetyczny gryf oraz eksport MusicJSON 0.3 do skrzypiec próbkowanych przez lokalny Python, FluidSynth i FreePats General MIDI. Model syntetyczny pozostaje dostępny do porównania. Szczegóły: [`renderowanie-skrzypiec.md`](renderowanie-skrzypiec.md).
